...
import { AlertCircleIcon, ArrowRightIcon, Globe2Icon, Loader2Icon } from "lucide-react";
...
const getProjectIcon = (project: Doc<"projects">) => {
  ...
  if (project.importStatus === "importing") {
    return (
      <Loader2Icon
        className="size-3.5 text-muted-foreground animate-ping"
      />
    )
  }
...
const ContinueCard: FC<ProjectItemProps> = (props) => {
  const { data } = props;
