...
export const getFiles = query({
  ...
  handler: async (ctx, args) => {
    ...
    if (project.ownerId !== indentity.subject) throw new Error("Unauthorized to access this project");
...
export const getFile = query({
  ...
  handler: async (ctx, args) => {
    ...
    if (!project) throw new Error("Project bot found");
...
export const createFile = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    if (existing) throw new Error("File arlready exists")
...
export const createFolder = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    if (existing) throw new Error("Folder arlready exists")
...
export const renameFile = mutation({
  ...
  handler: async (ctx, args) => {
    ...
    if (existing) throw new Error(`A ${file.type} with this same already exists in this location`);
